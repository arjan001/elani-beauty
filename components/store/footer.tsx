          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+254702642324" className="text-background/60 text-sm hover:text-background transition-colors">
                  0702 642 324
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail className="h-4 w-4 text-background/40 flex-shrink-0" />
                <a href="mailto:info@classycollections.com" className="text-background/60 text-sm hover:text-background transition-colors">
